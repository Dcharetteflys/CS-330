...
public:
	...
	//Need to add for the scroll wheel function 
	//This will callback for the mouse scroll wheel to adjus speed of movemtn 
	// scroll wheel callback for mouse interaction with the 3D scene
